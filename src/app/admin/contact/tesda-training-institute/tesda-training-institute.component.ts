...
@Component({
  selector: 'app-tesda-training-institute',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, ContactFilterPipe],
  templateUrl: './tesda-training-institute.component.html',
  styleUrl: './tesda-training-institute.component.scss',
})
export class TesdaTrainingInstituteComponent implements OnInit {
  ...
  ngOnInit(): void {
    const contactsByType$ = this.contactService.getAllByType(
      ContactType.TESDA_TRAINING_INSTITUTIONS
    );
